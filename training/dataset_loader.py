...
class Vocabulary:
    def __init__(self, freq_threshold):
        self.itos = {0: "<PAD>", 1: "<SOS>", 2: "<EOS>", 3: "<UNK>"}  # int to string
        self.stoi = {"<PAD>": 0, "<SOS>": 1, "<EOS>": 2, "<UNK>": 3}  # string to int
    ...
    def build_vocabulary(self, sentence_list):
        frequencies = {}
        idx = 4  # because we have already assigned idx {0,1,2,3}
...
class FlickrDataset(Dataset):
    def __init__(self, root_dir, captions_file, transform=None, freq_threshold=5):
        ...
        pickle.dump(self.vocab, open('../flickr8k_vocab.pkl', 'wb'))
